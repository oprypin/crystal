...
module OpenSSL::SSL::HostnameValidation
  ...
  def self.validate_hostname(hostname : String, server_cert : LibCrypto::X509) : OpenSSL::SSL::HostnameValidation::Result
  ...
  def self.matches_subject_alternative_name(hostname, server_cert : LibCrypto::X509) : OpenSSL::SSL::HostnameValidation::Result
  ...
  #
  # Adapted from https://wiki.openssl.org/index.php/Hostname_validation
  def self.matches_common_name(hostname, server_cert : LibCrypto::X509) : OpenSSL::SSL::HostnameValidation::Result
