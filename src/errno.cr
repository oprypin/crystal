...
enum Errno
  ...
  {% for value in %w(E2BIG EPERM ENOENT ESRCH EINTR EIO ENXIO ENOEXEC EBADF ECHILD EDEADLK ENOMEM
                    ...
                    EPROTO ETIME EOPNOTSUPP ENOTRECOVERABLE EOWNERDEAD EPROCLIM EBADRPC ERPCMISMATCH
                    EPROGUNAVAIL EPROGMISMATCH EPROCUNAVAIL EFTYPE EAUTH ENEEDAUTH ENOATTR EDOOFUS
                    ENOMEDIUM EASYNC ENOTCAPABLE ECAPMODE EINTEGRITY ENOTSUP EPWROFF EDEVERR EBADEXEC
                    EBADARCH ESHLIBVERS EBADMACHO ENOPOLICY EQFULL ECVCERORR ECVPERORR EIPSEC
                    EMEDIUMTYPE ECHRNG EL2NSYNC EL3HLT EL3RST ELNRNG EUNATCH ENOCSI EL2HLT EBADE EBADR
                    EXFULL ENOANO EBADRQC EBADSLT EDEADLOCK EBFONT ENONET ENOPKG EADV ESRMNT ECOMM
                    EDOTDOT ENOTUNIQ EBADFD EREMCHG ELIBACC ELIBBAD ELIBSCN ELIBMAX ELIBEXEC ERESTART
                    ESTRPIPE EUCLEAN ENOTNAM ENAVAIL EISNAM EREMOTEIO ENOKEY EKEYEXPIRED EKEYREVOKED
                    EKEYREJECTED ERFKILL EHWPOISON) %}
