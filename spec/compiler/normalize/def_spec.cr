...
describe "Normalize: def" do
  ...
  it "expands with two named argument and one not" do
    ...
    assert actual.to_s == "def foo:z(x, z)\n  y = 2\n  foo(x, y, z)\nend"
  end
  ...
  it "expands with magic constant with named arg" do
    ...
    assert other_def.to_s == "def foo:line(x, line, file = __FILE__)\n  foo(x, file, line)\nend"
  end
  ...
  it "expands a def with double splat and two named args and regular args" do
    ...
    assert other_def.to_s == "def foo:x:y:z(x, y, z)\n  options = {x: x, z: z}\n  y + options\nend"
  end
  ...
  it "expands a def with splat and double splat" do
    ...
    assert other_def.to_s == "def foo:x:y(__temp_1, __temp_2, x, y)\n  args = {__temp_1, __temp_2}\n  options = {x: x, y: y}\n  args + options\nend"
  end
  ...
  it "expands default value after splat index" do
    ...
    assert other_def.to_s == "def foo(x, __temp_1, __temp_2)\n  z = 10\n  y = {__temp_1, __temp_2}\n  (x + y) + z\nend"
  end

  it "uses bare *" do
    a_def = parse("def foo(x, *, y); x + y; end").as(Def)
    other_def = a_def.expand_default_arguments(Program.new, 1, ["y"])
    assert other_def.to_s == "def foo:y(x, y)\n  x + y\nend"
  end
  ...
  it "expands a def with external names (2)" do
    ...
    assert other_def.to_s == "def foo:y:x(y y1, x x1)\n  foo(x1, y1)\nend"
  end
