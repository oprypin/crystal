...
describe "Code gen: if" do
  it "codegens if without an else with true" do
    assert run("a = 1; if true; a = 2; end; a").to_i == 2
  end

  it "codegens if without an else with false" do
    assert run("a = 1; if false; a = 2; end; a").to_i == 1
  end

  it "codegens if with an else with false" do
    assert run("a = 1; if false; a = 2; else; a = 3; end; a").to_i == 3
  end

  it "codegens if with an else with true" do
    assert run("a = 1; if true; a = 2; else; a = 3; end; a").to_i == 2
  end

  it "codegens if inside def without an else with true" do
    assert run("def foo; a = 1; if true; a = 2; end; a; end; foo").to_i == 2
  end

  it "codegen if inside if" do
    assert run("a = 1; if false; a = 1; elsif false; a = 2; else; a = 3; end; a").to_i == 3
  end

  it "codegens if value from then" do
    assert run("if true; 1; else 2; end").to_i == 1
  end

  it "codegens if with union" do
    assert run("a = if true; 2.5_f32; else; 1; end; a.to_f").to_f64 == 2.5
  end
  ...
  it "codegens if with int" do
    assert run("if 1; 2; else 3; end").to_i == 2
  end

  it "codegens if with nil" do
    assert run("require \"nil\"; if nil; 2; else 3; end").to_i == 3
  end

  it "codegens if of nilable type in then" do
    assert run("if false; nil; else; \"foo\"; end").to_string == "foo"
  end

  it "codegens if of nilable type in then 2" do
    assert run("if 1 == 2; nil; else; \"foo\"; end").to_string == "foo"
  end

  it "codegens if of nilable type in else" do
    assert run("if true; \"foo\"; else; nil; end").to_string == "foo"
  end

  it "codegens if of nilable type in else 3" do
    assert run("if 1 == 1; \"foo\"; else; nil; end").to_string == "foo"
  end

  it "codegens if with return and no else" do
    assert run("def foo; if true; return 1; end; 2; end; foo").to_i == 1
  end

  it "codegens if with return in both branches" do
    assert run("def foo; if true; return 1; else; return 2; end; end; foo").to_i == 1
  end
