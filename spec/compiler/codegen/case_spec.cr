...
describe "Code gen: case" do
  it "codegens case with one condition" do
    assert run("require \"prelude\"; case 1; when 1; 2; else; 3; end").to_i == 2
  end

  it "codegens case with two conditions" do
    assert run("require \"prelude\"; case 1; when 0, 1; 2; else; 3; end").to_i == 2
  end

  it "codegens case with else" do
    assert run("require \"prelude\"; case 1; when 0; 2; else; 3; end").to_i == 3
  end
