...
describe Iterator do
  ...
  #     iter.rewind
  #     assert iter.to_a == [1, 2, 3, 4, 5, 6, 7, "a"]
  #   end

  #   it "flattens a variety of edge cases" do
  #     assert ([] of Nil).each.flatten.to_a == [] of Nil
  #     assert ['a'].each.flatten.to_a == ['a']
  #     assert [[[[[["hi"]]]]]].each.flatten.to_a == ["hi"]
  #   end
  # end
end
